...
clear; clc;
%Datos
d=40e3;              %Distancia entre estaciones en metros
d1O1=9.5e3;           %Distancia de la estacion 1 al obstaculo 1 en metros
d2O1=d-d1O1;         %Distancia de la estacion 2 al obstaculo 1 en metros
d1O2=26e3;           %Distancia de la estacion 1 al obstaculo 2 en metros
d2O2=d-d1O2;         %Distancia de la estacion 2 al obstaculo 2 en metros
eE1=287;             %Elevacion estacion 1 en metros
eE2=264;             %Elevacion estacion 2 en metros
eO1=311;             %Elevacion obstaculo 1 en metros 
eO2=306;             %Elevacion obstaculo 2 en metros 
h1=45;              %Altura estacion 1
h2=64;               %Altura estacion 2
f=38e9;              %Frecuencia de trabajo
