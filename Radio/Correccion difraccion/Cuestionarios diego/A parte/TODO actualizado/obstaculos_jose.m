...
clear; clc;
%Datos
d=20.10e3;              %Distancia entre estaciones en metros
d1O1=1.910e3;           %Distancia de la estacion 1 al obstaculo 1 en metros
d2O1=d-d1O1;         %Distancia de la estacion 2 al obstaculo 1 en metros
d1O2=3.721e3;           %Distancia de la estacion 1 al obstaculo 2 en metros
d2O2=d-d1O2;         %Distancia de la estacion 2 al obstaculo 2 en metros
eE1=796;             %Elevacion estacion 1 en metros
eE2=805;             %Elevacion estacion 2 en metros
eO1=803;             %Elevacion obstaculo 1 en metros 
eO2=799;             %Elevacion obstaculo 2 en metros 
h1=17;              %Altura estacion 1
h2=12;               %Altura estacion 2
f=2.3e9;              %Frecuencia de trabajo
