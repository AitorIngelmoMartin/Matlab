...
Ltdes_dB = Lbf_des_dB + Lnubes_dB + Lgases_dB + Margen_dB;
 

%Balance del enlace decendente

C_N0_des_dB = C_N0_sat_dB - C_N0_asc_dB;
...
OBO_portadora_dB = C_N0_des_dB - PIRE_sat_dBW - Ltdes_dB + G_T_et_dB - 10*log10(K);
