function [signal_ASK,digital_Signal] = modulacion_ASK(secuenciaBinaria,frecuencia,precision)

% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% modulacion_ASK devuelve la señal analógica y digital enviadas, a partir %
% de 3 parámetros.                                                        %
...
signal_ASK    = portadoraModulada.*mod;
