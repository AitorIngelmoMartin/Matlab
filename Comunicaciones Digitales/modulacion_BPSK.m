function [signal_BPSK,digital_Signal] = modulacion_BPSK(secuenciaBinaria,frecuencia,precision)

% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% modulacion_BPSK devuelve la señal analógica y digital enviadas, a partir %
% de 3 parámetros.                                                        %
